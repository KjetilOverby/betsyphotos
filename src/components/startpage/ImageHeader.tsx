      ...
      <style jsx>{`
        .start-container {
          ...
          background: linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.6)),
            url("https://images.unsplash.com/photo-1600091897034-cafc0da30dd7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3936&q=80");
